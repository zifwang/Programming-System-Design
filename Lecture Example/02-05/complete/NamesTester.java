...
public class NamesTester {
   ...
   */
   private static void testLookup() {
      ...
      doOneLookup(names, "Dave", false);
      doOneLookup(names, "Abby", false);
      doOneLookup(names, "Matt", false);
      doOneLookup(names, "Anne", true);
      doOneLookup(names, "Don", true);
   ...
   */
   ...
   /**
      ...
      Note: Uses "new" to create Strings to ensure they will be distinct
      objects from any other strings they are compared with (exposes
      equals vs. == bugs). [Really only need for inserts.]
   ...
   */
   private static void testAllThree() {
      ...
      doOneLookup(names, new String("Abby"), false);
      doOneLookup(names, new String("Joe"), true);
      ...
      doOneLookup(names, new String("Sam"), true);
   ...
   /**
      Test lookup of target in names, compares expectedResult to actual result,
      and prints out what happened.
   */
