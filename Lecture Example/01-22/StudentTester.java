...
public class StudentTester {
   public static void main(String[] args) {
      ...
      System.out.print("Student name and total score and average: ");
      System.out.println(stud1.getName() + " " + stud1.getTotalScore() + " " +
                        stud1.getAverage());

      // test that default constructor correctly creates student
      Student stud2 = new Student();
      System.out.print("Second student name and total score and average: ");
      ...
      System.out.println("Expected average: 10");
      stud1.addQuiz(10);
      ...
      System.out.println("Expected results for total: 44");
            System.out.println("Expected average: 8.8");
      System.out.print("Student name and total score and average: ");
      System.out.println(stud1.getName() + " " + stud1.getTotalScore() + " " +
                        stud1.getAverage());
